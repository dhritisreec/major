...
def get_split_info(args):
    ...
    with open(os.path.join(os.getcwd(), r'C:\Users\vuppu\malnet-graph\split_info_tiny\type\test.txt'), 'r') as f:

        lines_train = f.readlines()

    with open(os.path.join(os.getcwd(), r'C:\Users\vuppu\malnet-graph\split_info_tiny\type\train.txt'), 'r') as f:


        lines_val = f.readlines()

    with open(os.path.join(os.getcwd(), r'C:\Users\vuppu\malnet-graph\split_info_tiny\type\val.txt'), 'r') as f:
